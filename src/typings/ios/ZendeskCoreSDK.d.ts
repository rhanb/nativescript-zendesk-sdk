...
declare class ZDKPushProvider extends NSObject {
	...
	registerWithDeviceIdentifierLocaleCompletion(deviceIdentifier: string, locale: string, completion: (p1: string, p2: NSError) => void): void;

	registerWithUAIdentifierLocaleCompletion(UAIdentifier: string, locale: string, completion: (p1: string, p2: NSError) => void): void;
...
declare class ZDKUserProvider extends NSObject {
	...
	addTags(tags: NSArray<string> | string[], completion: (p1: NSArray<string>, p2: NSError) => void): void;

	deleteTagsCompletion(tags: NSArray<string> | string[], completion: (p1: NSArray<string>, p2: NSError) => void): void;

	getUserFieldsWithCompletion(completion: (p1: NSArray<ZDKUserField>, p2: NSError) => void): void;

	getUserWithCompletion(completion: (p1: ZDKUser, p2: NSError) => void): void;

	initWithZendesk(zendesk: ZDKZendesk): this;

	setUserFieldsCompletion(userFields: NSDictionary<string, any>, completion: (p1: ZDKUser, p2: NSError) => void): void;
}
...
declare class ZDKZendesk extends NSObject {
	...
	static initializeWithAppIdClientIdZendeskUrl(appId: string, clientId: string, zendeskUrl: string): void;
